...
def pergunta_de_verificacao(argumento):
    while True:
        pergunta=input(Fore.RED+f"Verifique a informação passada:\nVocê quis dizer {argumento} ?\n[S] para sim ou [N] para não:\t").upper()
        if pergunta=="S":
            ...
            with open('usuarios.txt' , 'a+', encoding='Utf_8', newline='') as arquivo_usuarios:
                ...
                while True:
                    ...
                    if emprego == "A":
                        ...
                        argumento=nome_da_banda
                        pergunta_de_verificacao(argumento)
